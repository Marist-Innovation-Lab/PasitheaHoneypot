...
% ~\cite{IRS}.  removed for space considerations  
...
%% Should we differentiate between low-interaction and high-interaction honeypots? It's probably fine as is, the concept is fairly self explanitory and if needed we can expand more in our Conclusions and Future Work section.
...
Because our original REST API was not designed to comprehensively log attack data, we only captured timestamp, command type, and command text from the initial attacks.  
